🏠 > [kostock](../../../) > [short-term](../../) > [단타매매](../) > `스캘핑매매법`
...
```cpp
신 = dayopen()*(100+상승률1)/100;   // 🟥21.0% : 2차 VI가격
호 = dayopen()*(100+상승률2)/100;   // 🟧10.0% : 1차 VI가격
등 = dayopen()*(100+상승률3)/100;   // 🟩 5.0% : 상승2차 관문
라 = dayopen()*(100+상승률4)/100;   // 🟦 2.0% : 상승1차 관문
