🏠 > [kostock](../../../) > [principles](../../) > [수식관리자](../) > [매매기법활용](../formula06.md) > `[단타] 상한가첫눌림 매매`
...
<table>
  ...
  <tr>
    <td colspan="6" align="right">
      <table>
        <tr align="center">
          <td width="120"><b href="./단타_상한가첫눌림.md">상한가첫눌림</b></td>
          <td width="120"><a href="./스윙_라운드넘버존.md">라운드넘버존</a></td>
        </tr>
      </table>
    </td>
  </tr>
