🏠 > [kostock](../../) > [stocks](../) > [테마종목](./) > `최신테마주`

<table>
  <tr>
    <td><a href="readme.md">Main</a></td>
    <td><b href="theme01.md">T1.최신</b></td>
...
| 종목 | 링크 | 비고 |
|-----|:----:|-----|
| 클로봇    | [[종합정보]][종합-466100]  [[차트보기]][차트-466100]  [[종목분석]][종목-466100] | 범용 자율주행 솔루션 CHAMELEON과 이기종로봇 FMS 및 관제 솔루션 CROMS를 라이선스로 공급하며, 공공생활 및 물류·제조자동화 영역에서 로봇 서비스를 제공하고 있음. |
| 로보스타  | [[종합정보]][종합-090360]  [[차트보기]][차트-090360]  [[종목분석]][종목-090360] | 제조공정 자동화를 위한 로봇을 공급하는 Robot 사업과 반도체 웨이퍼 및 장비를 제공하는 System Engineering 사업을 영위함. |
